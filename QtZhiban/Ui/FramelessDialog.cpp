...
#define max(a,b) ((a)>(b)? (a) :(b))
    ...
    void FramelessDialog::InitWidget()
    {
        setWindowFlags(Qt::FramelessWindowHint);
        setMouseTracking(true);
    }

    void FramelessDialog::ShowDialogMaxisize()
    {
        m_bShowNormal = false;
        showMaximized();
    }

    void FramelessDialog::ShowDialogMinisize()
    {
        showMinimized();
    }

    void FramelessDialog::ShowDialogNormal()
    {
        m_bShowNormal = true;
        showNormal();
    }

    void FramelessDialog::CheckEdge()
    {
        //计算鼠标距离窗口上下左右有多少距离
    ...
    void FramelessDialog::SlotCloseWidget()
    {
        close();
    }

    void FramelessDialog::SlotMinisizeWidget()
    {
        showMinimized();
    }

    void FramelessDialog::SlotMaxisizeWidget()
    {
        if (m_bShowNormal)
        {
            ShowDialogMaxisize();
    ...
    void FramelessDialog::SetMovableArea( QRect rectArea )
    {
        m_rectMovableArea = rectArea;
    }

    void FramelessDialog::SetDoubleClickedArea( QRect rectArea )
    {
        m_rectDoubleClickedArea = rectArea;
    }

    void FramelessDialog::SetResizeWidget( bool bState )
    {
        m_bResizeWidget = bState;
    }

    bool FramelessDialog::PointInArea( const QRect& rectArea, const QPoint& point )
    {
