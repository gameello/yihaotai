...
QT_MOC_LITERAL(1, 19, 18), // "checkStatusChanged"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 7) // "checked"

    },
    "CheckBoxHeaderView\0checkStatusChanged\0"
    "\0checked"
};
...
void CheckBoxHeaderView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CheckBoxHeaderView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->checkStatusChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CheckBoxHeaderView::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CheckBoxHeaderView::checkStatusChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CheckBoxHeaderView::staticMetaObject = { {
    &QHeaderView::staticMetaObject,
    qt_meta_stringdata_CheckBoxHeaderView.data,
    qt_meta_data_CheckBoxHeaderView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void CheckBoxHeaderView::checkStatusChanged(bool _t1)
{
